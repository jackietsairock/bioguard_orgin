$(function(){
    ...
    var li_index = 0;
    var slider_length = $('.sliderContent > ul >  li').length;


    $('.sliderContent > ul >  li').eq(li_index).fadeIn();
    ...
    $('.control li,.control2 li').click(function(){
        ...
        $('.sliderContent > ul >  li').css({'display':'none'});
        li_index = $(this).index();

        $('.sliderContent > ul >  li').eq(li_index).stop(true, false).fadeIn();
        $('.control li').eq(li_index).addClass('now');
        $('.control2 li').eq(li_index).addClass('now');
    });
