...
$rs = $mysqli->query("SELECT * FROM `news_update_english` ORDER BY `id` DESC ");
...
<head>
    <meta charset="UTF-8">
    <title>Bioguard corporation 百衛生物科技股份有限公司</title>
...
<div class="container">
    ...
    <div class="main_info">
        <div class="mainInfo_area_style">
            <div class="mainInfo_title_style"><b>LATEST&nbsp; NEWS</b></div>
            <ul class="news_area_box">
                <?php  while($row = $rs->fetch_assoc()): ?>
                    <li>
                        <a href="news1_english.php?id=<?= $row['id'] ?>"><b><?= $row['title'] ?></b></a>
                        </br>
                        <p><?= $row['bookdate'] ?></p>
                    </li>
                <?php endwhile; ?>
            ...
            <div class="mainInfo_link_style"><img src="images/icon/arrow_right.png" alt="" width="5" height="9"><a href="news_english.php"><p>News Overw</p></a></div>
        </div>
        <div class="mainInfo_area_style">
            <div class="mainInfo_title_style"><b>PRESENTATION</b></div>
        ...
        <div class="mainInfo_area_style">
            <div class="mainInfo_title_style"><b>ABOUT&nbsp; US</b></div>
            <div class="news_area_box">
                <ui>
                    <li><img src="images/index/首頁關於我們.jpg" alt="" width="280" ></li>
                    <li>Bioguard Corporation is a global animal
                        health company dedicated to innovation
                        and producing high-quality animal products.
                        We integrate the power of government,
                        academia, and industry and recruit
                        outstanding talent to develop innovative
                        animal vaccines. We focus on producing
                        safe and effective animal products to
                        improve animal health. Meanwhile, we
                        commit ourselves to corporate social
                        responsibility to ensure the rights of
                        consumers.</li>
                </ui>
            </div>
            <div class="mainInfo_link_style"><img src="images/icon/arrow_right.png" alt="" width="5" height="9"><a href="javascript:;"><p>Located innew Taipei industrial park</p></a></div>
            <div class="mainInfo_link_style"><img src="images/icon/arrow_right.png" alt="" width="5" height="9"><a href="innovation.php"><p>R&D center and manufacturing plant</p></a></div>
        </div>
    </div>
