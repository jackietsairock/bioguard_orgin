...
<!--        <p><a id="female_cart" href="javascript:;">全部切換母鳥卡</a></p><n>&nbsp;</n><n>&nbsp;</n>-->
        <p><a href="lactate.php">回到DNA鳥卡輸入</a></p>
    </div>
    <div class="cart_area">
        ...
        <div class="cart " id="cart1">
            ...
            <?php if($_SESSION['sex'] == "公鳥"): ?>
                <?php
                include(__DIR__ . '/__bird_cart_sex_male.php');
                ?>
            <?php else: ?>
                <?php
                include(__DIR__ . '/__bird_cart_sex_female.php');
                ?>
            <?php endif; ?>
                ...
                <ul>
                    ...
                    <li class="sex_area">
                        <?php if($_POST['sex2'] != ""): ?>
                            ...
                            include(__DIR__ . '/__sex.php');
                            ?>
                            <?php if($_POST['sex2'] == "公鳥"): ?>
                                <b class="blue big2">
                                    <?= $_POST['sex2'] ?>♂
                                </b>
                            <?php endif; ?>
                            <?php if($_POST['sex2'] == "母鳥"): ?>
                                <b class="red big2">
                                    <?= $_POST['sex2'] ?>♀
                                </b>
                            <?php endif; ?>
                ...
                <ul>
                    ...
                    <li class="sex_area">
                        <?php if($_POST['sex3'] != ""): ?>
                            ...
                            include(__DIR__ . '/__sex.php');
                            ?>
                            <?php if($_POST['sex3'] == "公鳥"): ?>
                                <b class="blue big2">
                                    <?= $_POST['sex3'] ?>♂
                                </b>
                            <?php endif; ?>
                            <?php if($_POST['sex3'] == "母鳥"): ?>
                                <b class="red big2">
                                    <?= $_POST['sex3'] ?>♀
                                </b>
                            <?php endif; ?>
                    ...
                    <ul>
                        ...
                        <li class="sex_area">
                            <?php if($_POST['sex4'] != ""): ?>
                                ...
                                include(__DIR__ . '/__sex.php');
                                ?>
                                <?php if($_POST['sex4'] == "公鳥"): ?>
                                    <b class="blue big2">
                                        <?= $_POST['sex4'] ?>♂
                                    </b>
                                <?php endif; ?>
                                <?php if($_POST['sex4'] == "母鳥"): ?>
                                    <b class="red big2">
                                        <?= $_POST['sex4'] ?>♀
                                    </b>
                                <?php endif; ?>
                    ...
                    <ul>
                        ...
                        <li class="sex_area">
                            <?php if($_POST['sex5'] != ""): ?>
                                ...
                                include(__DIR__ . '/__sex.php');
                                ?>
                                <?php if($_POST['sex5'] == "公鳥"): ?>
                                    <b class="blue big2">
                                        <?= $_POST['sex5'] ?>♂
                                    </b>
                                <?php endif; ?>
                                <?php if($_POST['sex5'] == "母鳥"): ?>
                                    <b class="red big2">
                                        <?= $_POST['sex5'] ?>♀
                                    </b>
                                <?php endif; ?>
                    ...
                    <ul>
                        ...
                        <li class="sex_area">
                            <?php if($_POST['sex6'] != ""): ?>
                                ...
                                include(__DIR__ . '/__sex.php');
                                ?>
                                <?php if($_POST['sex6'] == "公鳥"): ?>
                                    <b class="blue big2">
                                        <?= $_POST['sex6'] ?>♂
                                    </b>
                                <?php endif; ?>
                                <?php if($_POST['sex6'] == "母鳥"): ?>
                                    <b class="red big2">
                                        <?= $_POST['sex6'] ?>♀
                                    </b>
                                <?php endif; ?>
                    ...
                    <ul>
                        ...
                        <li class="sex_area">
                            <?php if($_POST['sex7'] != ""): ?>
                                ...
                                include(__DIR__ . '/__sex.php');
                                ?>
                                <?php if($_POST['sex7'] == "公鳥"): ?>
                                    <b class="blue big2">
                                        <?= $_POST['sex7'] ?>♂
                                    </b>
                                <?php endif; ?>
                                <?php if($_POST['sex7'] == "母鳥"): ?>
                                    <b class="red big2">
                                        <?= $_POST['sex7'] ?>♀
                                    </b>
                                <?php endif; ?>
                    ...
                    <ul>
                        ...
                        <li class="sex_area">
                            <?php if($_POST['sex8'] != ""): ?>
                                ...
                                include(__DIR__ . '/__sex.php');
                                ?>
                                <?php if($_POST['sex8'] == "公鳥"): ?>
                                    <b class="blue big2">
                                        <?= $_POST['sex8'] ?>♂
                                    </b>
                                <?php endif; ?>
                                <?php if($_POST['sex8'] == "母鳥"): ?>
                                    <b class="red big2">
                                        <?= $_POST['sex8'] ?>♀
                                    </b>
                                <?php endif; ?>
