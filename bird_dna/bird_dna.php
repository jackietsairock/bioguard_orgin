...
<div class="container">
    ...
    <a class="check_male" href="javascript:;"><p>全部切換公鳥</p></a>
    <a class="check_female" href="javascript:;"><p>全部切換母鳥</p></a>
    <p>---------------------------------------------------------</p>
    <?php
    include(__DIR__ . '/__link.php');
    ?>
    <form name="form1" class="form-horizontal" method="post" action="out_put.php">
    <div class="word"><b class="title">性別鳥卡1</b>
            ...
            <div class="form-group">
                <label for="sex" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex" name="sex" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex" name="sex" value="母鳥">母鳥
                </div>
            </div>
    ...
    <div class="word"><b class="title">性別鳥卡2</b>
            ...
            <div class="form-group">
                <label for="sex2" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex2" name="sex2" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex2" name="sex2" value="母鳥">母鳥
                </div>
            </div>
    ...
    <div class="word"><b class="title">性別鳥卡3</b>
            ...
            <div class="form-group">
                <label for="sex3" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex3" name="sex3" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex3" name="sex3" value="母鳥">母鳥
                </div>
            </div>
        ...
        <div class="word"><b class="title">性別鳥卡4</b>
            ...
            <div class="form-group">
                <label for="sex4" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex4" name="sex4" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex4" name="sex4" value="母鳥">母鳥
                </div>
            </div>
        ...
        <div class="word"><b class="title">性別鳥卡5</b>
            ...
            <div class="form-group">
                <label for="sex5" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex5" name="sex5" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex5" name="sex5" value="母鳥">母鳥
                </div>
            </div>
        ...
        <div class="word"><b class="title">性別鳥卡6</b>
            ...
            <div class="form-group">
                <label for="sex6" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex6" name="sex6" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex6" name="sex6" value="母鳥">母鳥
                </div>
            </div>
        ...
        <div class="word"><b class="title">性別鳥卡7</b>
            ...
            <div class="form-group">
                <label for="sex7" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex7" name="sex7" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex7" name="sex7" value="母鳥">母鳥
                </div>
            </div>
        ...
        <div class="word"><b class="title">性別鳥卡8</b>
            ...
            <div class="form-group">
                <label for="sex8" class="col-sm-2 control-label red">性別&nbsp;(*請選擇"公鳥"或"母鳥")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex8" name="sex8" value="公鳥" checked="checked">公鳥
                    <input type="radio" class="form-control" id="sex8" name="sex8" value="母鳥" >母鳥
                </div>
            </div>
