...
<style>
    *{
    ...
    .cart .word ul li:nth-child(9),.cart .word ul li:nth-child(10){
        margin-left: -130px;

    }

    .cart .word ul li:nth-child(9){
        margin-top: -36px;
    }
    ...
    .cart .word ul li:nth-child(10) b:nth-child(1){
        margin-top: 5px;
        font-size: 14px;
    }

    .cart .word ul li:nth-child(10) b:nth-child(2){
        font-size: 16px;
    }
...
<div class="container">
    <div class="index_orBack">
        ...
        <p><a href="two_virus.php">回雙病毒輸入</a></p>
    </div>
    <div class="cart_area">
        ...
        <?php if($_POST['test_nb'] != ""): ?>
            <div class="cart " id="cart1">
                <div class="bird_pic" id="bird_pic1">
                    ...
                    <?php
                    include(__DIR__ . '/__two_virus_bg.php');
                    ?>
                ...
                <div class="word">
                    <ul>
                        ...
                        <li>
                            <?php
                            include(__DIR__ . '/__virus1.php');
                            ?>
                            <?php if($_POST['pbfd'] == "陽性"): ?>
                                <b class="blue">
                                    <?= $_POST['pbfd'] ?>(+)
                                </b>
                            <?php else: ?>
...
<script>
    ...
    $(function(){
        ...
        $('.bird_pic_area li').removeClass('block');
        $('.bird_pic_area li:nth-child(2)').addClass('block');

//        $('#male_cart').click(function(){
//            $('.aa').removeClass('cart_block');
//            $('.male_cart_area').addClass('cart_block');
//
//        });
//
//        $('#female_cart').click(function(){
//            $('.aa').removeClass('cart_block');
