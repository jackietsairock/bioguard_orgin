...
<div class="container">
    ...
    ?>
    <form name="form1" class="form-horizontal" method="post" action="lactate_out_put.php">
        <div class="word"><b class="title">LDHA-鳥卡1</b>
            ...
            <div class="form-group">
                <label for="sex" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex" name="sex" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex" name="sex" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex" name="sex" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡2</b>
            ...
            <div class="form-group">
                <label for="sex2" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex2" name="sex2" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex2" name="sex2" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex2" name="sex2" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡3</b>
            ...
            <div class="form-group">
                <label for="sex3" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex3" name="sex3" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex3" name="sex3" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex3" name="sex3" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡4</b>
            ...
            <div class="form-group">
                <label for="sex4" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex4" name="sex4" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex4" name="sex4" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex4" name="sex4" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡5</b>
            ...
            <div class="form-group">
                <label for="sex5" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex5" name="sex5" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex5" name="sex5" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex5" name="sex5" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡6</b>
            ...
            <div class="form-group">
                <label for="sex6" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex6" name="sex6" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex6" name="sex6" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex6" name="sex6" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡7</b>
            ...
            <div class="form-group">
                <label for="sex7" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex7" name="sex7" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex7" name="sex7" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex7" name="sex7" value="BB-普通">BB-普通
                </div>
            </div>
        ...
        <div class="word"><b class="title">LDHA-鳥卡8</b>
            ...
            <div class="form-group">
                <label for="sex8" class="col-sm-2 control-label red">LDHA&nbsp;(*請選擇"哪一型")</label>
                <div class="col-sm-10 sexCheck">
                    <input type="radio" class="form-control" id="sex8" name="sex8" value="AA-最佳" checked="checked">AA-最佳
                    <input type="radio" class="form-control" id="sex8" name="sex8" value="AB-好">AB-好
                    <input type="radio" class="form-control" id="sex8" name="sex8" value="BB-普通">BB-普通
                </div>
            </div>
