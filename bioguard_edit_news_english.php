...
<head>
    <meta charset="UTF-8">
    <title>百衛官網後台-最新消息-英文Bioguard-websystem-news-english</title>
...
<div class="container">
    ...
    <div class="news_link">
        <a href="bioguard_edit_news_ch.php">最新消息-中(繁)</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="bioguard_edit_news_chs.php">最新消息-中(簡)</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="bioguard_edit_news_english.php">最新消息-英文</a>
    </div>
    </br></br>
    <form name = 'form' action = '__news_update_english.php' method='post'>
        <h1 class="title_word blue">百衛生物科技官網後台-最新消息-英文</h1>
        <h1 class="title_word blue">Bioguard-websystem-news-english</h1>
        </br>
        <p></p>
        </br>
        <div class="form-group">
            <label for="title" class="col-sm-2 control-label red" >**請輸入標題(Enter-title)：</label>
            <div class="col-sm-12">
        ...
        <div class="form-group">
            <label for="bookdate" class="col-sm-2 control-label red">**日期(Select-date)：</label>
            <div class="col-sm-10">
        ...
        <input type = 'button' value = '送出(send)' onclick = 'processData()'>
    </form>
    </br>
    <div class="news_link">
        <a href="bioguard_delete_news_english.php"><n>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</n>→前往刪除最新消息←</br><n>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</n>(Go to delete news)</a>
    </div>
    </br>
    </br>
