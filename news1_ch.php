...
$rs = $mysqli->query("SELECT * FROM news_update_ch WHERE `id`= $id");
...
<div class="container">
    ...
    <div class="right_area">
        <div class="position_path_area">
            ...
            <div class="position_path position_path_style2"><a href="news_ch.php"><p>最新消息</p></a></div>
            <div class="position_path"><p>></p></div>
            <div class="position_path position_path_style2"><a href="news1_ch.php?id=<?= $row['id'] ?>"><p><?php echo $row['bookdate']; ?></p></a></div>
        </div>
        <div class="slider">
            <!--            <div class="control">-->
