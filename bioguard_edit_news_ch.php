...
<div class="container">
    ...
    <form name = 'form' action = '__news_update_ch.php' method='post'>
        <h1 class="title_word blue">百衛生物科技官網後台-最新消息-中(繁)</h1>
        </br>
        <p></p>
        </br>
    ...
    <div class="news_link">
        <n>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</n><a href="bioguard_delete_news_ch.php">→前往刪除最新消息←</a>
    </div>
    </br>
    </br>
